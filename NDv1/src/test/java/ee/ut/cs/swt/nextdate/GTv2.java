...
public class GTv2 {
	...
	public void testCreatesNextDate1() throws Throwable {
	    NextDate nextDate0 = new NextDate(3143, 3143, 3143);
	    String string0 = nextDate0.run(3, 30, 1812);
	    assertEquals("3/31/1812", string0);
	}
	...
	public void testCreatesNextDate5() throws Throwable {
	    NextDate nextDate0 = new NextDate((-1468), (-1468), (-1468));
	...
	public void testRunWithNegative() throws Throwable {
	    ...
	    String string0 = nextDate0.run(3189, (-2127), 9);
	    assertEquals("invalid Input Date", string0);
	}
